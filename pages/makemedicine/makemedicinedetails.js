...
Page({
  ...
  onLoad: function(options) {
    ...
    app.globalData.zhixin = { type: 2, val: this, dosome: this.onLoad }
    this.query(this, this.data.options.mid);
  ...
  onShow: function() {
    ...
    if (coupon != null && coupon != "") {
      ...
      this.data.makeInfo.orderprescriptioninfos[0].actualprice = this.data.makeInfo.orderprescriptioninfos[0].actualprice.toFixed(2);
